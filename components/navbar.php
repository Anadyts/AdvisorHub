    ...
    <nav>
        ...
        <ul>
            ...
            if (isset($_SESSION['username']) && ($_SESSION['role'] == 'advisor' ||  $_SESSION['role'] == 'student')) {
                ...
                echo "<li><a href='/AdvisorHub/summary/'>Summary</a></li>";
...
<style>
    body {
        margin: 0;
        font-family: "Noto Sans Thai", system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji" !important;
    }
    ...
    nav li a {
        line-height: 1;
        /* รีเซ็ต line-height ที่อาจมาจาก BS5 */
    }
