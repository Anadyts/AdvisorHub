...
// คิวรีข้อมูลที่รอการอนุมัติจากแอดมิน
$sql = "SELECT
        ...
        WHERE ar.is_admin_approved = 0 AND ar.partner_accepted != 2 AND ar.is_advisor_approved != 2";
...
<head>
    ...
    <link rel="stylesheet" href="style/admin_pending.css">
...
<body>
    ...
    <div class="filter-card">
        <h3>ค้นหาและกรองข้อมูลคำร้องขอที่รอแอดมินอนุมัติ</h3>
        ...
        <table>
            ...
            <tbody id="requestTableBody">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='9' class='no-data'>ไม่มีคำขอที่รอดำเนินการจาก admin</td></tr>";
                }
                ?>
            </tbody>
        </table>
