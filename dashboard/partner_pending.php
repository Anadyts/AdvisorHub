...
// คิวรีข้อมูล โดยจะกรองปีการศึกษาถ้ามีค่า GET และ partner_accepted = 0
$sql = "SELECT 
        ...
        <table>
            ...
            <tbody id="requestTableBody">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='9' class='no-data'>ไม่มีคำขอที่รอดำเนินการจาก Partner</td></tr>";
                }
                ?>
            </tbody>
        </table>
            ...
            onChange: function(values) {
                ...
                fetch('advisors.php', {
                        ...
                        body: 'advisors=' + encodeURIComponent(JSON.stringify(values)) +
                            ...
                            '&partner_pending=1' // บอกว่าเป็นการกรองสำหรับ Partner Pending
                    })
