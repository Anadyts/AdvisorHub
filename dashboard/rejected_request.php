        ...
        function filterTable() {
            ...
            fetch('filter_advisor.php', {
                    ...
                    body: 'advisors=' + encodeURIComponent(JSON.stringify(advisors)) +
                        ...
                        '&search_student_id=' + encodeURIComponent('<?php echo $search_student_id; ?>') +
                        '&search_student_name=' + encodeURIComponent('<?php echo $search_student_name; ?>') +
                        '&search_thesis_topic=' + encodeURIComponent('<?php echo $search_thesis_topic; ?>')
                })
