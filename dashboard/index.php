        ...
        <a href="/AdvisorHub/dashboard/admin_pending.php">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-number">
                        <?php
                            $sql = "SELECT COUNT(*) as count FROM advisor_request WHERE partner_accepted = 1 AND is_admin_approved = 0 AND is_advisor_approved != 2";
                            $result = $conn->query($sql);
                            echo $result->fetch_assoc()['count'];
                        ?>
                    </div>
        ...
        <a href="/AdvisorHub/dashboard/advisor_pending.php">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-number">
                    <?php
                        $sql = "SELECT COUNT(*) as count FROM advisor_request WHERE partner_accepted = 1 AND is_admin_approved != 2 AND is_advisor_approved = 0 ";
                        $result = $conn->query($sql);
                        echo $result->fetch_assoc()['count'];
                    ?>
                    </div>
